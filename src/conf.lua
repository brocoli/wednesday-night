...
function love.conf(t)
    ...
    t.window.title = "Wednesday Night"  -- The window title (string)
    t.window.icon = "assets/wednesday-night.ico" -- Filepath to an image to use as the window's icon (string)
